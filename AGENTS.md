...
Raccourci natif Ctrl + . : annotations actives → pause, site lié → démarrage/reprise, sinon ouverture de la popup. Ne pas injecter de capteur clavier sur tous les sites. Tester les touches dans un affichage Xvfb isolé.
